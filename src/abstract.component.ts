...
export abstract class AbstractComponent {
    ...
    constructor(@Inject(ElementRef) private elemRef: ElementRef, public _dragDropService: DragDropService, public _config: DragDropConfig,
        ...
        this._elem.ondragstart = (event: DragEvent) => {
            ...
            if (event.dataTransfer != null) {
                ...
                // Change drag effect
                event.dataTransfer.effectAllowed = this.effectAllowed as any || this._config.dragEffect.name as any;
                // Change drag image
